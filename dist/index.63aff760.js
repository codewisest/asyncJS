...
_shoppingCartJs.addToCart("apple", 20);
_shoppingCartJs.addToCart("orange", 20);
(0, _shoppingCartJsDefault.default)("beer", 5);
...
parcelHelpers.export(exports, "default", ()=>function(product, quantity) {
        cart.pop();
        console.log(`${quantity} ${product} removed from cart`);
    });
